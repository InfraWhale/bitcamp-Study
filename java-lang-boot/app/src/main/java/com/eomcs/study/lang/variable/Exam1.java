...
@RestController("lang.variable.exam1") // 클래스 이름 같을경우 충돌 방지
@RequestMapping("/lang/variable/exam1")
public class Exam1 {

  // 변수 선언
  //- 값을 저장할 메모리를 준비하는 명령문
  ...
  //http://localhost:8080/lang/variable/exam1/test2?b=127&s=-32768&i=2100000000&l=9220000000000000000
  @GetMapping("/test2")
  ...
  //- 메모리 크기에 따른 값의 유효범위
  //http://localhost:8080/lang/variable/exam1/test3?f=987654.321654987&d=987654.321654987123456789
  @GetMapping("/test3")
  ...
  // 문자변수선언
  //- ......
  //http://localhost:8080/lang/variable/exam1/test4?c=A
  ...
  public String test5(boolean b) {
    ...
    //  return "클라이언트에서 받은 값= " + b + "," + (int) b; // 문법적으로 안된다
  }
