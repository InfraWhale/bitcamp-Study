...
CREATE TABLE lms_stud (
  ...
  sch_nm  VARCHAR(30) NULL     COMMENT '최종학교', -- 최종학교
...
ALTER TABLE lms_stud
  MODIFY COLUMN sno INTEGER NOT NULL AUTO_INCREMENT COMMENT '수강생번호';
...
CREATE TABLE lms_center (
  cntno INTEGER     NOT NULL COMMENT '교육센터번호', -- 교육센터번호
  name  VARCHAR(30) NOT NULL COMMENT '센터명' -- 센터명
)
COMMENT '교육센터';
...
CREATE TABLE lms_dept (
  dno  INTEGER     NOT NULL COMMENT '부서번호', -- 부서번호
  name VARCHAR(30) NOT NULL COMMENT '부서명' -- 부서명
)
COMMENT '부서';
...
CREATE TABLE lms_position (
  pono INTEGER     NOT NULL COMMENT '직급번호', -- 직급번호
  name VARCHAR(30) NOT NULL COMMENT '직급명' -- 직급명
)
COMMENT '직급';
...
CREATE TABLE lms_grade (
  gno   INTEGER     NOT NULL COMMENT '학력번호', -- 학력번호
  title VARCHAR(30) NOT NULL COMMENT '학력명' -- 학력명
)
COMMENT '학력';
...
CREATE TABLE lms_work_type (
  wtno  INTEGER     NOT NULL COMMENT '고용형태번호', -- 고용형태번호
  title VARCHAR(30) NOT NULL COMMENT '고용형태명' -- 고용형태명
)
COMMENT '고용형태';
