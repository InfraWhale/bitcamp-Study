...
public class Exam0240 {
	public static void main(String[] args) throws Exception {
		...
		// 스태틱 메서드 활용
		long currMillis = System.currentTimeMillis(); // UTC 1970년 1월 1일 00:00:00.000 을 기준으로한 현재 시간의 차이를 long형으로 반환한다.
		System.out.println(currMillis);

		// 생성자 활용
		java.sql.Date today = new java.sql.Date(currMillis); // 유틸 클래스보다 이거 더 많이쓴다
